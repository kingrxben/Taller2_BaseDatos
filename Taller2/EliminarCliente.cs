...
namespace Taller2
{
    public partial class EliminarCliente : Form
    {
        ...
        {
            string query = "SELECT CodigoCliente,NombreCliente,Ciudad FROM clientes WHERE Estado = 0";
            DataTable data = ConnectMySQL.Instance.SelectQuery(query);
            DatosCliente.DataSource = data;
        }
        ...
        private void Eliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                new MySqlParameter("@id", DatosCliente.CurrentCell.Value)
            };
